...
{
    public class UpdateBoothDtoValidator : AbstractValidator<UpdateBoothDto>
    {
        public UpdateBoothDtoValidator()
        {
            RuleFor(b=> b.Id).NotEmpty().WithMessage("شناسه نباید خالی باشد").NotNull().WithMessage("شناسه نباید خالی باشد");
